...
document.addEventListener("DOMContentLoaded", function () {
  $(function ($) {
    ...
    // banner-carousel
    let bannerCarouselSecond = document.querySelector(
    ...
    if (bannerCarouselSecond) {
      const swiper = new Swiper(bannerCarouselSecond, {
        ...
        paginationClickable: true,
        navigation: {
          nextEl: bannerCarouselSecond
            .closest("section")
            .querySelector(".ara-next"),
          prevEl: bannerCarouselSecond
            .closest("section")
            .querySelector(".ara-prev"),
        },
      });
    }
    ...
    let bannerCarouselFourth = document.querySelector(
      ".banner-carousel-fourth"
    );
    if (bannerCarouselFourth) {
      const swiper = new Swiper(bannerCarouselFourth, {
        ...
        slidesPerView: 1,
        navigation: {
          nextEl: bannerCarouselFourth
            .closest("section")
            .querySelector(".ara-next"),
          prevEl: bannerCarouselFourth
            .closest("section")
            .querySelector(".ara-prev"),
        },
        breakpoints: {
    ...
    if (testimonialCarousel) {
      const swiper = new Swiper(testimonialCarousel, {
        ...
        paginationClickable: true,
        navigation: {
          nextEl: testimonialCarousel
            .closest("section")
            .querySelector(".ara-next"),
          prevEl: testimonialCarousel
            .closest("section")
            .querySelector(".ara-prev"),
        },
      });
    ...
    // carouselInfinity
    let carouselInfinitySecond = document.querySelectorAll(
      ".carousel-infinity-second"
    );
    ...
    // testimonial-carousel
    let testimonialCarouselSecond = document.querySelector(
    ...
    if (testimonialCarouselSecond) {
      const swiper = new Swiper(testimonialCarouselSecond, {
        ...
        paginationClickable: true,
        navigation: {
          nextEl: testimonialCarouselSecond
            .closest("section")
            .querySelector(".ara-next"),
          prevEl: testimonialCarouselSecond
            .closest("section")
            .querySelector(".ara-prev"),
        },
        pagination: {
          el: testimonialCarouselSecond
            .closest("section")
    ...
    // testimonial-carousel
    let testimonialCarouselThird = document.querySelector(
    ...
    if (testimonialCarouselThird) {
      const swiper = new Swiper(testimonialCarouselThird, {
        ...
        paginationClickable: true,
        navigation: {
          nextEl: testimonialCarouselThird
            .closest("section")
            .querySelector(".ara-next"),
          prevEl: testimonialCarouselThird
            .closest("section")
            .querySelector(".ara-prev"),
        },
        pagination: {
          el: testimonialCarouselThird
            .closest("section")
            .querySelector(".slider-pagination"),
        },
        breakpoints: {
